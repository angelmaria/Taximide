# con registro de actividad en el sidebar de la izquierda
...
def cambiar_contraseña():
    nueva_contraseña = st.text_input("Ingresa la nueva contraseña:", type="password", max_chars=20, key="input_contraseña")
    confirmar_contraseña = st.text_input("Confirma la nueva contraseña:", type="password", max_chars=20, key="confirmar_contraseña")
...
def finalizar_programa():
    ...
    # Guardar registro en el base de datos
...
def visualizar_log():
    st.sidebar.title("Registro de Actividad")
    with open('taximetro.log', 'r') as log_file:
        log_contents = log_file.read()
        st.sidebar.code(log_contents, language='plaintext')
...
def pagina_inicio():
    ...
    contrasena = st.text_input("Ingresa la contraseña:", type="password", max_chars=20, key="input_contraseña")
...
def pagina_principal():
    visualizar_log()  # Mostrar el log en el sidebar derecho
    ...
    if st.sidebar.button("🛑 Finalizar Programa", key="boton_finalizar"):
        finalizar_programa()
